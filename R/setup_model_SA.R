...
params <- list(
  ...
  # Cattle in Free State and Northern Cape 2010
  # https://www.dalrrd.gov.za/Home/Crop-Estimates/Statistical-Information/Livestock
  N_liv = 508940 + 2291969,

  # livestock population age structure  and death rates proportion of
  ...
  imm_t0 = c(0.29, 0.48, 0.8, 0.87, 0.87) * 0.01,
  ...
  # total population of farmers checked from world bank
  # and USAID report from 2008 - 30% pop farmers
  N_hum = 1379618,
  ...
  # Reporting fraction. fraction of human infections reported

  RR = 0.75,
  RRreport = 0.75, # Increse of reporting over the yeras (2013 to 2019)

  # Latent period in humans in days
  # (to calculate the rate at which human move from latent to infectious)
  D_lat_H = 4 / 30,

  # Infectious period in humans in days
  # (to calculate the rate at which human move from infectious to immune)
  D_inf_H = 9 / 30,
  ...
  # case fatality rate
  CFR = 0.054, # Reported in SA NCDI

  # Clinical fraction
  clin_frac = 1 - 0.88, # Turkey data (Bodur et al.)

  # Mortality and birth rates in human for constant pop size
  # life span in years  between 2008 and 2014
